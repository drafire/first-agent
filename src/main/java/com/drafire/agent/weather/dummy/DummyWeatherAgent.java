...
@Service
public class DummyWeatherAgent {

    private final ReactAgent reactAgent;

    public DummyWeatherAgent(@Value("${ali.api-key}") String apiKey) {
        ...
        ToolCallback toolCallback = FunctionToolCallback.builder("getWeather", new DummyWeatherTool()) //注意这里的name，最好不要有空格
